...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  useEffect(() => {
    if (!isClient || isMobile || !cursorRef.current) return;
  ...
  }, [targetSelector, spinDuration, moveCursor, constants, hideDefaultCursor, isMobile, isClient, hoverDuration, parallaxOn]);

  useEffect(() => {
    if (!isClient || isMobile || !cursorRef.current || !spinTl.current) return;
  ...
  }, [spinDuration, isMobile, isClient]);
