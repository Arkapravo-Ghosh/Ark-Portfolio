...
export const experiences: Experience[] = [
  {
    ...
    description: [
      ...
      "Set up autoscaling microservices with zero-downtime deployments and auto-recovery on AWS EKS using ArgoCD and ECR.",
    ],
    technologies: [
      "React",
      "TypeScript",
  ...
  },
  {
    ...
    endDate: "Aug 2025",
    description: [
      "Built a multi-theme pitch-deck PDF export service and led 70% of a performance sprint, increasing customization usage 15% and reducing workflow latency 10%.",
      "Implemented async workers, batched DB access, and LRU caching; cut average response time 20% and boosted throughput 35%.",
      "Integrated AWS (S3, EC2, CloudWatch) for resilience: 99.9% uptime and handled 3x traffic spikes without incident.",
    ],
    technologies: [
      "TypeScript",
      "Node.js",
